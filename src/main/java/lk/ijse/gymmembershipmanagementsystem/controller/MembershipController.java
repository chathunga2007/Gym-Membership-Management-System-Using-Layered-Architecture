...
public class MembershipController implements Initializable {
    ...
    private final MembershipBO membershipBO = (MembershipBO) BOFactory.getInstance().getBO(BOFactory.BOType.MEMBERSHIP);
    ...
    private void save() {
        ...
        try{
            ...
            boolean result = membershipBO.saveMembership(membershipDTO);
            if (result) {
    ...
    private void update() {
        ...
        try {
            ...
            boolean result = membershipBO.updateMembership(membershipDTO);
            if (result) {
                Alert alert = new Alert(Alert.AlertType.INFORMATION);
    ...
    private void delete() {
        ...
        try {
            boolean result = membershipBO.deleteMembership( id);
            if (result) {
    ...
    private void handleSearchMemberships(KeyEvent event) {
        if (event.getCode() == KeyCode.ENTER) {
            try {
                ...
                MembershipDTO membershipDTO = membershipBO.searchMembership(id);
    ...
    private void loadMemberID(){
        try {
            ObservableList<MemberDTO> idList = membershipBO.loadMemberID();
    ...
    public void loadMembershipTable() {
        try {
            ...
            List<MembershipDTO> membershipList = membershipBO.getAllMembership();
