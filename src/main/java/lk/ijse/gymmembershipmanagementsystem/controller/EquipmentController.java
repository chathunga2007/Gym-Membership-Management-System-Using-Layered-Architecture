...
public class EquipmentController implements Initializable {
    ...
    private void save() {
        ...
        if (!qty.matches(QTY_REGEX)) {
            ...
            boolean result = equipmentBO.saveEquipment(equipmentDTO);
                if (result) {
    ...
    private void update() {
        ...
        if (!qty.matches(QTY_REGEX)) {
            ...
            try {
                ...
                boolean result = equipmentBO.updateEquipment(equipmentDTO);
    ...
    private void delete() {
        ...
        try {
            boolean result = equipmentBO.deleteEquipment( id);
    ...
    private void handleSearchEquipment(KeyEvent event) throws SQLException {
        ...
        if (event.getCode() == KeyCode.ENTER) {
            try {
                ...
                EquipmentDTO equipmentDTO = equipmentBO.searchEquipment(id);
