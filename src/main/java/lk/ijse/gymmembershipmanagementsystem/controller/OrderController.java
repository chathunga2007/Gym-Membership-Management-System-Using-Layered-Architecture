...
public class OrderController implements Initializable {
    ...
    private void loadMemberIds() {
        try {
            List<MemberDTO> memberList = memberBO.getAllMembers();
    ...
    private void handleSelectSupplementId(ActionEvent event) {
        ...
        try {
            SupplementDTO supplementDTO = supplementBO.searchSupplement(selectedId);
    ...
    private void handlePlaceOrder(ActionEvent event) {
        ...
        try {
            ...
            boolean isOrderPlaced = orderBO.placeOrder(orderDTO);
