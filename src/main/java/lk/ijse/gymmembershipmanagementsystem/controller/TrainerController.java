...
public class TrainerController implements Initializable {
    ...
    private void save() {
        ...
        if(!name.matches(NAME_REGEX)) {
            ...
            boolean result = trainerBO.saveTrainer(trainerDTO);
                if (result) {
    ...
    private void update() {
        ...
        if(!name.matches(NAME_REGEX)) {
            ...
            try {
                ...
                boolean result = trainerBO.updateTrainer(trainerDTO);
    ...
    private void delete() {
        ...
        try {
            boolean result = trainerBO.deleteTrainer( id);
    ...
    private void handleSearchTrainer(KeyEvent event) throws SQLException {
        ...
        if (event.getCode() == KeyCode.ENTER) {
            try {
                ...
                TrainerDTO trainerDTO = trainerBO.searchTrainer(id);
    ...
    public void loadTrainerTable() {
        try {
            ...
            List<TrainerDTO> trainerList = trainerBO.getAllTrainers();
