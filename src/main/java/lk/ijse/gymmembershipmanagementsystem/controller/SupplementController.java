...
public class SupplementController implements Initializable {
    ...
    private final SupplementBO supplementBO = (SupplementBO) BOFactory.getInstance().getBO(BOFactory.BOType.SUPPLEMENT);
    ...
    private void save() {
        ...
        if(!qty.matches(ITEM_QTY_REGEX)) {
            ...
            try {
                ...
                boolean result = supplementBO.saveSupplement( supplementDTO);
                if (result) {
    ...
    private void update() {
        ...
        if(!qty.matches(ITEM_QTY_REGEX)) {
            ...
            try {
                ...
                boolean result = supplementBO.updateSupplement(supplementDTO);
    ...
    private void delete() {
        ...
        try {
            boolean result = supplementBO.deleteSupplement( id);
    ...
    private void handleSearchSupplement(KeyEvent event) {
        ...
        if (event.getCode() == KeyCode.ENTER) {
            try {
                ...
                SupplementDTO supplementDTO = supplementBO.searchSupplement(id);
    ...
    public void loadSupplementTable() {
        try {
            ...
            List<SupplementDTO> supplementDTOList = supplementBO.getAllSupplements();
